...
/**
 * Class ModuleBookReader.
 *
 * Front end module "book reader".
 */
class ModuleBookReader extends ModuleBook
{
     ...
     * @var string
     */
    protected $strTemplate = 'mod_bookreader';
    ...
    public function generate()
    {
        ...
        // Do not index or cache the page if no book item has been specified
        if (!Input::get('items')) {
            global $objPage;
            $objPage->noSearch = 1;
            $objPage->cache = 0;
